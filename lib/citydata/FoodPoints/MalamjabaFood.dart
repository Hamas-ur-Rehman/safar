...
class MalamJabaFood extends StatefulWidget {
  @override
  _MalamJabaFoodState createState() => _MalamJabaFoodState();
}

class _MalamJabaFoodState extends State<MalamJabaFood> {
  _onTap(int index) {
    switch (index) {
      case 0:
