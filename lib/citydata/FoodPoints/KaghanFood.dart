...
class KaghanFood extends StatefulWidget {
  @override
  _KaghanFoodState createState() => _KaghanFoodState();
}

class _KaghanFoodState extends State<KaghanFood> {
  _onTap(int index) {
    switch (index) {
      case 0:
