...
class MurreeFood extends StatefulWidget {
  @override
  _MurreeFoodState createState() => _MurreeFoodState();
}

class _MurreeFoodState extends State<MurreeFood> {
  _onTap(int index) {
    switch (index) {
      case 0:
  ...
  List food = [
    {
      'name': "Pinetree Restaurant",
      'address':
          "Pir Sohawa Road\nHighland Country\nClub & Resort,\nSangra,\nNear Islamabad,\nSangada 22620\nPakistan",
      'imagex':
          "https://media-cdn.tripadvisor.com/media/photo-s/1a/97/d2/1b/nestled-in-the-heart.jpg",
      'call': '+92 51 2806136',
      'url':
          "https://www.facebook.com/highlandresort.pk/photos/the-pine-tree-restaurant-at-highland-resort-is-one-of-its-kind-serving-up-a-set-/1760589743975612/",
    },
    {
    ...
    },
    {
      ...
      'address':
          "Hotel Road\nPearl\nContinental Hotel,\nBhurban,\nMurree 44000\nPakistan",
      'imagex':
          "https://media-cdn.tripadvisor.com/media/photo-s/0b/09/cc/66/nadia-main-enterance.jpg",
      'call': '+92 51 3355701',
      'url': "https://www.facebook.com/PC.Bhurban/",
    },
  ];
  @override
