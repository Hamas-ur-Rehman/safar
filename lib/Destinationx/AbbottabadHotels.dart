...
class AbbottabadHotels extends StatefulWidget {
  @override
  _AbbotabadHotelsState createState() => _AbbotabadHotelsState();
}

class _AbbotabadHotelsState extends State<AbbottabadHotels> {
  _onTap(int index) {
    switch (index) {
      case 0:
