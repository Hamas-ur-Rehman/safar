...
class ThattaHotels extends StatefulWidget {
  @override
  _ThattaHotelsState createState() => _ThattaHotelsState();
}

class _ThattaHotelsState extends State<ThattaHotels> {
  _onTap(int index) {
    switch (index) {
      case 0:
  ...
  List abbottabadhotels = [
    ...
    },
    {
      ...
      'address':
          'W-2/10,\nNorth\nWestern,\nIndustrial\nZone,\nPort\nMuhammad\nBin Qasim،\nNorth\nWestern\nIndustrial\nZone Port\nQasim Bin\nQasim Town,\nKarachi City,\nSindh 75020',
      'imagex':
          'https://media-cdn.tripadvisor.com/media/photo-s/09/d0/46/29/the-enterprise.jpg',
      'url':
          'https://www.expedia.com/Karachi-Hotels-The-Enterprise.h13193209.Hotel-Information?chkin=2020-07-07&chkout=2020-07-08&x_pwa=1&rfrr=HSR&pwa_ts=1594011495845&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=1809&destination=Karachi%2C+Sindh%2C+Pakistan&destType=MARKET&selected=13193209&sort=RECOMMENDED&top_dp=75&top_cur=USD&MDPCID=PK.META.HPA.HOTEL-CORESEARCH-desktop.HOTEL&MDPDTL=HTL.13193209.20200707.20200708.DDT.1.CID.6495822717.AUDID.&mctc=10&gclid=Cj0KCQjw9IX4BRCcARIsAOD2OB1b1GOZuSZscSsW5Cx1EQZ4fdAAql35nAK3g2x0PZHBJhTHn9JH4I8aAsTREALw_wcB&semdtl=&selectedRoomType=201383912&selectedRatePlan=286254814',
      'price': 'PKR 14,146',
      'call': '0300 8286637',
    },
    {
